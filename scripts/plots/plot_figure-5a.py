...
pretty_configs = ["OF", "OF+M(PV)", "OF+M(F)"]
...
for w in workloads :
    ...
    for c in configs:
        ...
        if "M" in c and val != 0:
            ...
            ax.text(idx - 0.15, val + 0.4, label_text, rotation=90, fontsize=12)
...
ax.set_xticklabels(datalabels, rotation=30, fontsize=10,
